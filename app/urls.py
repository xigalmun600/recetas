...
urlpatterns = [
    ...
    path(
        "receta/<int:receta_pk>/agregar_ingrediente/<int:ingrediente_pk>",
        views.receta_agregar_ingrediente,
        name="receta_agregar_ingrediente",
    ),
    ...
    path(
        "ingredientes/nuevomodel",
        views.ingredientes_nuevo_model,
        name="ingredientes_nuevo_model",
    ),
]
